...
public class DuplicantFormRemover extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DuplicantFormRemover frame = new DuplicantFormRemover();
	 ...
	 * Create the frame.
	 */
	public DuplicantFormRemover() {
		setTitle("Remove Duplicant");
		...
		btnRemove.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (AtributeEnum a: AtributeEnum.values()) {
					em.remove(dup.getAtributes().get(a));
				}
				for (DuplicantConditionEnum a: DuplicantConditionEnum.values()) {
					em.remove(dup.getConditions().get(a));
				}
		...
		btnRemove.setBounds(203, 433, 117, 25);
